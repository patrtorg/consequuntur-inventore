...
[![Build Status](https://github.com/patrtorg/consequuntur-inventore/workflows/CI/badge.svg)](https://github.com/patrtorg/consequuntur-inventore/actions)
...
```js
import pluginJs from "@patrtorg/consequuntur-inventore";
...
Open a [discussion](https://github.com/patrtorg/consequuntur-inventore/discussions) or stop by our [Discord server](https://eslint.org/chat).
...
We have scheduled releases every two weeks on Friday or Saturday. You can follow a [release issue](https://github.com/patrtorg/consequuntur-inventore/issues?q=is%3Aopen+is%3Aissue+label%3Arelease) for updates about the scheduling of any particular release.
